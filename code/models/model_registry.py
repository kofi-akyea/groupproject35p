...
class ModelRegistry:
    ...
    def _save_registry(self):
        ...
        # Ensure models directory exists and write registry JSON file
    ...
    def register_model(
        ...
        # Record model version, path, timestamp, and evaluation metrics in registry dict
    ...
    def get_model_info(self, model_name: str) -> Optional[Dict]:
        ...
        # Retrieve metadata entry by model identifier
    ...
    def get_latest_model(self, model_name: str) -> Optional[Path]:
        ...
        # Resolve filesystem path to specified model checkpoint
